module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c6 = function(target, val) {
        		return mk('assign', {
        			target 	: target.name,
        			value 	: val
        		});
        	},
        peg$c7 = function(receiver, message) {
        		return mk('send', {
        			receiver	: receiver,
    ...
    function peg$parseMessage() {
      ...
      s0 = peg$parseArgMessage();
      if (s0 === peg$FAILED) {
        s0 = peg$parseNoArgMessage();
      }

      return s0;
    }

    function peg$parseArgMessage() {
      var s0, s1, s2, s3, s4, s5;

      s0 = peg$currPos;
      s1 = peg$parseArgMessagePair();
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
        s4 = peg$parse__();
        if (s4 !== peg$FAILED) {
          s5 = peg$parseArgMessagePair();
          if (s5 !== peg$FAILED) {
            s4 = [s4, s5];
            s3 = s4;
          } else {
    ...
    function peg$parseArgMessagePair() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseNoArgMessage() {
      var s0, s1, s2;
