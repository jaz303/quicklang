...
function string(ctx) {
    ...
    var string = T.make();
    T.addParent(string, 'object', ctx.$object);

    T.setSlot(string, 'toInteger', function(ctx, self) {
...
function boolean(ctx) {

    var bool = T.make();
    T.addParent(bool, 'object', ctx.$object);

    T.setSlot(bool, 'asBoolean', function(ctx, self) {
        return self;
    });
...
function block(ctx) {
    ...
    var block = T.make();
    T.addParent(block, 'object', ctx.$object);

    T.setSlot(block, 'asBoolean', function(ctx, self) {
        return ctx.evalBlock(self);
    });
